...
pursuit_dir="/home/mathias/NL/MAS/app/pursuit-domain-v0.9-bin/bin"
pursuit="${pursuit_dir}/pursuit"
pursuit_conf="pursuit.conf"
monitor_dir="/home/mathias/NL/MAS/app/pursuit-domain-v0.9-bin/bin"
monitor="${monitor_dir}/pursuit_monitor"
monitor_conf="monitor.conf"
predator="java Predator"
prey="/home/mathias/NL/MAS/app/pursuit-domain-v0.9-bin/bin/prey"
